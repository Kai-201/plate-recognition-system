...
public class MqResultReceiver {
    ...
    public void onResult(Map<String, Object> result) {
        ...
        if ("SUCCESS".equals(status)) {
            ...
            s.put("annotated_video_url", result.getOrDefault("annotatedVideoUrl", ""));
            try {
                task.setPlatesJson(new ObjectMapper().writeValueAsString(s));
        ...
        log.info("MQ 结果已推送 SSE: taskId={}", taskId);
    }
}
